...
<head>
    ...
    <title>Ecommerce / Women Shoes</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid" style="margin-top:118px;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Women Shoes</li>
            </ol>
        </nav>
    </div>
    <div class="container-fluid">
        Women Shoes - 35 items
        <div class="row">
            ...
            <div class="col-md-7 col-lg-7 col-sm-7">
                <ul class="d-flex">
                    <li class="p-1"><a href="#">Women Chappals</a></li>
                    <li class="p-1"><a href="#">Women Sandals</a></li>
                    <li class="p-1"><a href="#">Women Sneakers</a></li>
                    <li class="p-1"><a href="#">Women Loafers</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 col-xl-3">
                                <div class="single-product card_section">
                                    <div class="product-img product_image">
                                        <a href="women_Shoes_desc.php"><img class="img-fluid w-100"
                                                src="img/women_shoes/ws1.jpg" alt="" /></a>
                                        <div class="p_icon w-100 p-1">
                                            <div class="row justify-content-center">
                                                <a href="women_shoes_desc.php">
                                                    <i class="ti-eye"></i>
                                                </a>
                                                <a href="#">
                                                    <i class="ti-heart"></i>
                                    ...
                                    <div class="product-btm">
                                        <a href="women_shoes_desc.php" class="d-block">
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 col-xl-3">
                                <div class="single-product card_section">
                                    <div class="product-img product_image">
                                        <img class="img-fluid w-100" src="img/women_shoes/ws1.jpg" alt="" />
                                        <div class="p_icon w-100 p-1">
                                            <div class="row justify-content-center">
                                                <a href="#">
                                                    <i class="ti-eye"></i>
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 col-xl-3">
                                <div class="single-product card_section">
                                    <div class="product-img product_image">
                                        <img class="img-fluid w-100" src="img/women_shoes/ws1.jpg"
                                            alt="" />
                                        <div class="p_icon w-100 p-1">
                                            <div class="row justify-content-center">
                                                <a href="#">
